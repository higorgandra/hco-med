...
import { 
  ...
  Award, RefreshCw, Smartphone, HandCoins, Building as BuildingIcon, Info, MapPin as MapPinIcon, User as UserIcon, Lock, CheckCircle as CheckCircleIcon, Calculator, ExternalLink, BarChart, FolderOpen, GraduationCap, Lightbulb, Percent, Save, Briefcase, Eraser, Download
} from 'lucide-react';

function FichaCadastral({ onBack }) {
      ...
      <header className="fixed w-full bg-white shadow-md z-50">
        ...
        <div className="max-w-6xl mx-auto px-4 py-3 flex justify-between items-center">
          ...
          <nav className="hidden lg:flex items-center gap-6 text-sm font-medium text-slate-600">
            ...
            <button onClick={() => setCurrentPage('cadastro-ficha')} className="bg-[#0F2C4A] text-white px-5 py-2 rounded-full hover:bg-[#0A1F35] transition font-bold shadow-lg shadow-slate-300 flex items-center gap-2">
              <FileText size={18} />
              Cadastro
            </button>
          </nav>
