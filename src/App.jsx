        ...
        <div className="hidden md:block bg-white text-[#0F2C4A] text-xs py-1 border-b border-slate-100">
          <div className="max-w-6xl mx-auto px-4 flex justify-between items-center">
            ...
            <div className="hidden md:flex items-center gap-4 font-medium">
              ...
              <span className="flex items-center gap-1"><MapPin size={12} className="text-[#0F2C4A]" /> Rua Senador Theotônio Vilela, 190 Ed. Convention Center 3º andar - Parque Bela Vista, Salvador - BA, 40279-435</span>
            </div>
          </div>
        </div>
